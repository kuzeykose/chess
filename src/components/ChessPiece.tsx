...
const pieces = {
  ...
  'black-rook': (
    <svg xmlns="http://www.w3.org/2000/svg" width="45" height="45">
      <g stroke="#000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
        <path d="M9 39h27v-3H9v3zM12.5 32l1.5-2.5h17l1.5 2.5H12.5zM12 36v-4h21v4H12z" strokeLinecap="butt" fill="#000"/>
  ...
  'white-bishop': (
    <svg xmlns="http://www.w3.org/2000/svg" width="45" height="45">
      <g fill="#fff" stroke="#000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
        ...
        <path d="M17.5 26h10M15 30h15m-7.5-14.5v5M20 18h5" stroke="#000" fill="none"/>
      </g>
    </svg>
  ),
  'black-bishop': (
    <svg xmlns="http://www.w3.org/2000/svg" width="45" height="45">
      <g fill="none" fillRule="evenodd" stroke="#000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
        ...
        <path d="M17.5 26h10M15 30h15m-7.5-14.5v5M20 18h5" stroke="#fff" fill="none"/>
      </g>
    </svg>
  ),
  'white-knight': (
